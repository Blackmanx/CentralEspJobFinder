  ...
  return [
    {
      ...
      url: "https://es.indeed.com/jobs?q=Colegio+Brains+Educador+Infantil",
      scrapedAt: new Date().toISOString(),
      source: "Indeed",
    ...
    },
    {
      ...
      url: "https://es.indeed.com/jobs?q=Liceo+Sorolla+Profesor+Infantil",
      scrapedAt: new Date().toISOString(),
      source: "Indeed",
    ...
    },
    {
      ...
      url: "https://es.indeed.com/jobs?q=Colegio+Base+Tecnico+Superior+Infantil",
      scrapedAt: new Date().toISOString(),
      source: "Indeed",
